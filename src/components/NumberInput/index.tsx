...
function NumberInput<T extends string | undefined>(props: Props<T>) {
  ...
  const handleChange: RawInputProps<T>['onChange'] = React.useCallback((v: React.SetStateAction<string | undefined>, n: T, e: React.FormEvent<HTMLInputElement> | undefined) => {
    setTempValue(v);
